...
// let guests: string[] = ["Sana", "Sara", "Mahnoor"];
// console.log("Great news! I found a bigger dinner table!");

// guests.unshift("Saqib");
// guests.splice(guests.length / 2, 0, "Jameel");
// guests.push("khadija");
...
// let places: string[] = ["Afghanistan", "Saudi Arabia", "Africa", "Switzerland", "Norway"];
